...
class ReportRepositoryImpl implements ReportRepository {
  ...
  ReportDataEntity _mapReportDataToEntity(ReportDataModel model) {
    return ReportDataEntity(
      totalScreenTime: model.totalScreenTime,
      totalUrlsVisited: model.totalUrlsVisited,
      totalAppsUsed: model.totalAppsUsed,
      appUsageByApp: model.appUsageByApp,
      urlVisitsByDomain: model.urlVisitsByDomain,
      topApps: model.topApps,
      topDomains: model.topDomains,
    );
  }
